...
public class VectorTileDecoderTest extends TestCase {
    ...
    public void testPolygon() throws IOException {
        LinearRing shell = gf.createLinearRing(new Coordinate[] { new Coordinate(10, 10),
    ...
    public void testPolygonWithHole() throws IOException {
        ...
        LinearRing hole = gf.createLinearRing(new Coordinate[] { new Coordinate(11, 11),
                new Coordinate(11, 19), new Coordinate(19, 19), new Coordinate(19, 11),
